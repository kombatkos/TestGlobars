...
//        }
//
//        CLLocation.init(latitude: 53.456623, longitude: 46.34674)
//    }
...
//            if segueIdentifier == "getAddress" { showCarLocation(mapView: mapView) }
//            break
//        case .denied:
//            DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
//                self.showAlert(
...
//    }
    ...
    func showCarLocation(mapView: MKMapView, location: CLLocationCoordinate2D?) {
    ...
    func centerLocation(for mapView: MKMapView, latitude: Double, longitude: Double) -> CLLocation {
        return CLLocation(latitude: latitude, longitude: longitude)
    }
